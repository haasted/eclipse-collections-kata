...
public abstract class CompanyDomainForKata
{
    ...
    private void setUpCustomersAndOrders()
    {
        ...
        fredOrder.addLineItems(3, new LineItem("cup", 1.5));

        // TODO 7: Add 3 saucers at 1.0 each to the order
        fredOrder.addLineItems(3, new LineItem("saucer", 1.0));
        ...
        maryOrder.addLineItems(4, new LineItem("cup", 1.5));

        // TODO 7: Add 4 saucers at 1.50 each to the order
        maryOrder.addLineItems(4, new LineItem("saucer", 1.5));
        ...
        billOrder1.addLineItems(43, new LineItem("gnome", 7.50));
